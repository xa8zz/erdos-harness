...
logical holes.  The conditional T2 construction has a Lean-verified finite
core and residual comparison layer, but the safe-edge wrapper of
\Cref{prop:t2-finite-capture} is not closed.  The endgame reduction
...
0 in current files &
Local graph/hypergraph potential inequalities and residual comparison are formalized; the safe-edge wrapper remains open \\
\hline
...
contains zero-sorry formalizations of local finite potential inequalities and
the residual comparison layer, but \Cref{prop:t2-max-gain-counterexample}
shows that the naive max-gain wrapper is false in rank three.  Thus
\Cref{thm:t2} is stated conditionally on the remaining safe-edge hypothesis
rather than as a fully closed theorem.
\end{remark}
