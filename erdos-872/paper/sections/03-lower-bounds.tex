...
The proof is deferred to \Cref{app:t2-proof}.  We describe the strategy here,
because the construction is the bridge between the one-dimensional lower-bound
mechanism above and the later discussion of second-order obstructions.
...
total target mass and is nondecreasing under a max-gain Maker move, up to a
negligible token-deletion error.
...
The appendix proves these ingredients in order: the abstract finite potential
game, the residual divisibility embedding, the activation-stage token
bookkeeping, the prime-counting estimates, and the final conversion to the
stated lower bound.
