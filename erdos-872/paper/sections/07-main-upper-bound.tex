...
\[
  n/\lambda^r<b_I\le n.
\]
By \Cref{lem:product-strip-reciprocal} with $C=\lambda^r$ and $c=a$, these
tuples have total $b$-reciprocal contribution
\[
  O_{H,\lambda,a,r}(1/\log n)=o_{H,\lambda}(1).
\]
This proves \eqref{eq:queued-bridge-moment}.
\end{proof}
