...
1. **Adaptive shield count.** Compute the minimum $k$ required to hold $\beta(P_k)/n \le 0.40$ for $n = 1000, 2000, 5000$ under some shield rule. What growth law governs it — constant, $O(\log \log n)$, $O(\log n)$?
