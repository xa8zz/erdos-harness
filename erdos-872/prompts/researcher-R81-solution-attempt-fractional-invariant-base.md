...
<!-- Dispatched 2026-07-11 with (a) manuscript files 02-notation-and-setup.tex, 04-lower-bounds.tex, appendix-A-deferred-proofs.tex at commit 018a346 appended under "# Appended manuscript source (LaTeX)", and (b) the verbatim body of researcher-78-fractional-invariant-interdiction-frontier.md appended under "# Appended note". -->
