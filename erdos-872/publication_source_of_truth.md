...
- `Rigorous prose + Lean-banked endgame reduction + Pro-audit-confirmed moment convergence`: the Round 15 finite Bonferroni-4 upper bound `L(n) <= (W_4/2 + o(1)) n` with `W_4/2 = 0.1897112 < 0.19`. Architecturally split into: (i) Lean-banked endgame at `lean/erdos_872_core/RequestProject/Round15Bonferroni4/Target.lean` (zero sorries) — theorem `eventually_strict_lt_point19_of_componentwise_close` says that if the four Round 15 moment terms are componentwise within `10^-5` of `J_1..J_4`, then `L(n) < 0.19n` eventually; (ii) Pro-audit-confirmed analytic side (R60) — Theorem 2.1 (prime-sequence Bonferroni-4 comparison) + Theorem 4.1 (prime-rounding bridge from Round 57 real envelope scale `(b_j)` to increasing odd primes `(p_j)` with `sup p_j/b_j = 1 + o(1)`) together supply the moment-convergence hypotheses.
...
|---|---|---|---|---|
| **0.19n upper bound (R57 + R60)** | `L(n) <= (W_4/2 + o(1)) n` with `W_4/2 = 0.1897112 < 0.19` | **strategy-specific** (Shortener plays smallest legal odd prime on first `K = (1-eps) n/(2 log n)` turns — NOT sigma^*) | **Lean-banked endgame reduction (Target.lean, 0 sorries) + Pro-audit-confirmed analytic components (R60 Theorems 2.1 + 4.1).** | Canonical sources: `researcher-57-pro-round15-bonferroni4-PROVED-L-le-0.19n.md` (original Round 57 proof), `r57_bonferroni4_audit_and_repair.md` (Codex audit + prime-sequence comparison theorem repair), `researcher-60-pro-R57-repair-PROVED-theorems-2-1-and-4-1.md` (R60 Pro rigorous proof of both theorems), `lean/erdos_872_core/RequestProject/Round15Bonferroni4/Target.lean` (Lean-banked endgame reduction). R60 repaired the bridge construction: local-density bound (LC) forces `sup p_j/b_j = 1 + o(1)`, not just PNT. Does NOT depend on sigma^*. |
