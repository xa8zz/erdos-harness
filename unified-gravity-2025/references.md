...
- **[Chishtie 2025 — Canadian J. Phys.]** Restricting One-Loop radiative effects in quantum gravity: Demonstrating 4D GR as an EFT and its consistent unification with the Standard Model. *Canadian Journal of Physics (accepted); arXiv:2503.09796.* Chishtie's **primary framework paper** establishing USMEG-EFT (Unified Standard Model with Emergent Gravity–EFT). Section structure: Introduction; Lagrange multiplier approach to quantum gravity; Dimensional regularization and emergence of derivative; Graviton-matter interactions; Mathematical proof using Appelquist-Carazzone decoupling theorem; Unification with Standard Model. Builds on Brandt-Frenkel-McKeon's 2020 Lagrange-multiplier approach to quantum gravity. Claims "Newton's constant remains fixed (no running of G_N) yet exhibits logarithmic dependence" encoding "a limited domain of validity for General Relativity." Uses Appelquist-Carazzone decoupling for "a well-defined low-energy limit." Claims "first successful unification of gravity with the Standard Model through a fully renormalizable and EFT framework." **The framework's structural alignment with R04's EFT-descendant prediction is direct**: Chishtie has independently reached an EFT-based unification conclusion via different machinery (Lagrange-multiplier-restricted GR, not teleparallel + counterterm-basis enlargement). Strong corroboration of the EFT-route side of R04's two-descendant trade-off.
- **[Chishtie 2025 — arxiv preprint]** Theoretical and experimental basis for excluding Einstein-Cartan theory within the USMEG-EFT framework. *arXiv:2509.08848.* Argues "Einstein-Cartan generates non-renormalizable four-fermion interactions producing catastrophic quartic divergences" (~κ⁴Λ⁴). Cites MICROSCOPE experimental constraint on equivalence-principle violations at 10⁻¹⁵ vs Einstein-Cartan prediction of 10⁻¹². USMEG-EFT achieves unification using standard 4D GR with constraints. Does not mention Partanen-Tulkki by name in the abstract-level content.
- **[Chishtie 2026 — MDPI Symmetry]** BRST Symmetry Violation and Fundamental Limitations of Asymptotic Safety in Quantum Gravity. *Symmetry 18, 140 (January 2026).* Paywall-blocked; full content not fetched. Title suggests BRST cohomology analysis arguing fundamental limitations of asymptotic safety. Potentially relevant to our R02-R04 BRST analysis.
- **[Chishtie 2025 — arxiv]** Emergent spacetime from spatial energy potentiality: A new theoretical framework for early universe cosmology. *arXiv:2502.18524.* Cosmological extension of the USMEG-EFT framework — spacetime emerges via a first-order phase transition when quantum-generated kinetic terms exceed a critical threshold.
...
- **[Partanen & Tulkki 2025d — atomic Dirac redshift]** *Atomic Dirac energy-level dynamics and redshift in the 4×U(1) gravity gauge field.* arXiv:2506.22057 (June 27, 2025). Tree-level classical application: solves the Dirac equation for hydrogen-like atoms in a 4×U(1) gravity gauge field; reproduces gravitational redshift; predicts spectral line splitting in strong gravitational fields from gravitational-potential-gradient breaking of nuclear-electric-potential symmetry. No loop-renormalization content. Adds to the Partanen-Tulkki classical-phenomenology corpus (now: 2310.01460 main paper, 2310.02285 QED companion, 2505.14446 light deflection, 2506.14447 perihelion, 2506.22057 atomic redshift, 2507.07790 graviton-graviton extension, plus 2 corrigenda).
