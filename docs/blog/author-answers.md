# Author raw answers — vibe research blog draft source

**Date:** 2026-04-21
**Author:** Om Buddhdev
**Purpose:** Verbatim source material for the blog post draft. Section headers added for navigability; no editing of content. This is the ground truth for what the author actually said. Any later draft must be traceable back to these quotes.
...
Author's expanded pitch (answering "one-sentence pitch to a friend"):

> I used AI to come up with math that I do not understand that has never been produced by any human before. My hook would be similar for question one.

## Thesis: autonomous AI research is inevitable; human is the bottleneck
...
> There is also, I'm just saying this right here, remind me if I forget, that we should do some cool visuals for our write up with our progress and stuff.
...
## The harness as a continual-learning substitute
...
## Models giving up; model-family personalities; the Claude pep-talk
...
## Initial rules; never picked a map
...
## Models are bad at context and harness engineering
...
## Generalization beyond Erdős 872
...
## Vibe researching: where vibe coding was eight months ago
